...
if (!class_exists('WC_Deposits_Email_Customer_Remaining_Reminder')) :
    ...
    class WC_Deposits_Email_Customer_Remaining_Reminder extends WC_Email
    {
        ...
        function __construct()
        {
            ...
            $this->title = esc_html__('Partial Payment Reminder', 'woocommerce-deposits');
            $this->description = esc_html__('Reminder of partially-paid order sent to the customer', 'woocommerce-deposits');
        ...
        {
            return esc_html__('Your {site_title} order partial payment reminder {order_date}', 'woocommerce-deposits');
        }
        ...
        {
            return esc_html__('Partial Payment Reminder #{order_number}', 'woocommerce-deposits');
        }
        ...
        {
            return esc_html__("Kindly be reminded that your order's partial payment is still pending payment.", 'woocommerce-deposits');

        }

        public function get_default_payment_text()
        {
            return esc_html__('To make payment, please visit this link: {wcdp_payment_link}', 'woocommerce-deposits');
        }
        ...
        public function init_form_fields()
        {
            ...
            $this->form_fields = array(
                ...
                'subject' => array(
                    'title' => esc_html__('Partial payment reminder subject', 'woocommerce-deposits'),
                    'type' => 'text',
                    'desc_tip' => true,
                    'description' => sprintf(esc_html__('For partial payment reminders (%s)', 'woocommerce-deposits'), esc_html__('Payment plans', 'woocommerce-deposits')),
